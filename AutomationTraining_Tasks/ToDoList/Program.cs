namespace ToDoList
{
    ...
    {
        /*
         * Create a console application "ToDo list". The application should contain four functions: see current todos, add new, remove current, exit from the app.
           When the application starts, it shall print:
                ...
                [R]emove a TODO
                [E]xit
           The user must select one of the given S, A, R, E options. The selected option can be both uppercase or lowercase, so it doesn’t matter if the user types “S” or “s” - both should go to the “see all todos” case. 
           ...
           Positive flow: User selects any of the S,s,A,a,R,r,E,e options -> The correct option is handled. After it is finished, the choice of options is printed again (unless the Exit option was chosen, which closes the app).
           Negative flow: User does not select any option (empty choice), or the selected option is not valid -> “Incorrect input” is printed to the console. 
           Then, the selection of choices is printed again. It is repeated until the user provides the correct input.
           ...
           Positive flow: The list of all TODOs is printed to the console. Then, the choice of options is printed again.
           Negative flow: There are no TODOs at all -> “No TODOs have been added yet.” is printed to the console. Then, the choice of options is printed again.
           ...
           Positive flow: User inputs a unique, non-empty description of a TODO. -> “TODO successfully added: [DESCRIPTION]” is printed to the console. TODO is added to the collection. The choice of options is printed again to the console.
           Negative flows: 
           The description the user provided is empty. -> “The description cannot be empty.” is printed to the console. No TODO is added. “Enter the TODO description” is printed again.
           There is already a TODO with the same description as the user provided. -> “The description must be unique.” is printed to the console. No TODO is added. “Enter the TODO description” is printed again.
           ...
           Positive flow: User inputs a correct index of a TODO. -> “TODO removed: [DESCRIPTION]” is printed to the console. TODO is removed from the collection of TODOs. The choice of options is printed again to the console.
           Negative flows: 
           ...
           The index the user inputs is either not a number or it is not a valid index in the collection. -> “The given index is not valid.” is printed to the console. No TODO is removed. “Select the index of the TODO you want to remove” is printed again.
