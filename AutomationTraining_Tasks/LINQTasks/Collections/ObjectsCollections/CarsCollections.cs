...
namespace LINQTasks_answers.Collections.ObjectCollections
{
    public static class CarsCollections
    {
        ...
        {
            new Car(1, Marks.Audi, "A6", CarType.Sedan, Color.Yellow, 1560, 250),
            new Car(2, Marks.Mersedes, "GLE", CarType.Crossover, Color.White, 2150, 260),
            new Car(3, Marks.Mersedes, "Actros", CarType.Truck, Color.Red, 12000, 120),
            new Car(4, Marks.VW, "Passat", CarType.Sedan, Color.Green, 1590, 262),
            new Car(5, Marks.BWM, "X3", CarType.Crossover, Color.Blue, 1640, 270),
            new Car(6, Marks.Toyota, "Camry", CarType.Sedan, Color.Green, 1530, 180),
        ...
        public static List<Car> CarsOwnedByOneUser = new()
        {
                ...
                new Car(2, Marks.Mersedes, "GLE", CarType.Crossover, Color.White, 2150, 260, UsersCollections.Petr.Name),
