...
using SharePointTestSuiteTask.Common.Web.Extensions;
using SharePointTestSuiteTask.Common;

namespace SharePointTestSuiteTask.Common.Web.BaseElements;

internal class CustomWebElement(By by) : IWebElement
{
